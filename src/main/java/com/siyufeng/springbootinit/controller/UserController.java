...
import com.siyufeng.springbootinit.config.WxOpenConfig;
...
import com.siyufeng.springbootinit.model.dto.user.*;
import com.siyufeng.springbootinit.model.vo.LoginUserVO;
...
import static com.siyufeng.springbootinit.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    @GetMapping("/updateAccessKey")
    public BaseResponse<Boolean> updateMyUser(HttpServletRequest httpServletRequest) {
        userService.updateSignature(httpServletRequest);
        return ResultUtils.success(true);
    }
}
